 ...
 */
final class Version20200416080630 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE type ADD CONSTRAINT FK_8CDE5729D44E9764 FOREIGN KEY (subzone_id) REFERENCES subzone (id)');
